...
This is usually derived through the specific form.
\begin{align*}
...
\begin{figure}[h!]
    ...
    \caption{The area of the rectangle $a$,$b$ can't be larger than sum of the areas under the functions (red) and (yellow). (WIKIPEDIA)}
\end{figure}
