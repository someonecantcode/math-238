...
becomes $e^{mx} \left(am^2+bm+c\right)$ where we can solve for when $m = 0$. With induction, we can apply this for $n$ amount of derivatives.

\begin{equation}
    c_1 y^{n} + c_2 y^{n-1} + \dots + c_{n} y^{1} + c_{n+1} y^{0} = 0, \quad y = e^{mx}
\end{equation}

\begin{equation}
    e^{mx} \left(c_1 m^{n} + c_2 m^{n-1} + \dots + c_{n} m^{1} + c_{n+1} m^{0}\right) = 0
\end{equation}
...
\begin{solution}
    ...
    \begin{align*}
        ...
        & m = \frac{3 \pm \sqrt{-23}}{2} \\
        & m = \frac{3}{2} + i\sqrt{23},\quad \frac{3}{2} - i\sqrt{23} \\
        & y = e^{\alpha x} \left(C_1 \cos(\beta x) + C_2 \sin(\beta x)\right) \\
    \longrightarrow    & \boxed{y = e^\frac{3x}{2} \left(C_1 \cos(\sqrt{23} x) + C_2 \sin(\sqrt{23} x)\right)}
    \end{align*}
...
\begin{solution}
    ...
    \begin{align*}
                        ...
                        & m = -\frac{1}{2} \pm 1 \\
                        & m = \frac{1}{2}, -\frac{3}{2} \\
     \Longrightarrow    & y_g(x) = C_1 e^{\frac{x}{2}} + C_2e^{-\frac{3x}{2}}
    \end{align*}
